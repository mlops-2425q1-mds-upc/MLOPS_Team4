...
def train_logistic_regression_model():
    ...
    with mlflow.start_run(run_name=f"{model_name}_LogisticRegression"):
        ...
        log_reg_model = LogisticRegression(
            max_iter=max_iter, solver=solver, n_jobs=-1
        )
        ...
        mlflow.sklearn.log_model(log_reg_model, artifact_path='model_LogisticRegression')
        ...
        print(f"Predicted Sentiment (Logistic Regression): {predict_sentiment_logreg(sample_text)}")
